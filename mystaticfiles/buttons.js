// Get pieces to fill with players' pieces
...
// Get buttons in order to hide it once a player presses it
...
// Get a random number from 1-2. If it is 1, player x starts. If it is 2, player o starts. 
...
// If count is odd, it is player x's turn to play. if count is even, it is player o's turn to play. 
function myFunction() {
    if (count%2 == 0){
        text1.innerHTML = "O";
    } else {
